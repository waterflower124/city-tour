...
+ (UIImage * _Nullable)imageWithColor:(UIColor * _Nullable)color andSize:(CGRect)frame;

+ (UIImage *_Nullable)imageWithWaterMark:(UIImage *_Nullable)image withTempSize :(CGSize)tempSize;
