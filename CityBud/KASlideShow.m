...
- (void) setDefaultValues
{
    ...
    [_topImageView setContentMode:UIViewContentModeScaleToFill];
    _bottomImageView = [[UIImageView alloc] initWithFrame:self.bounds];
    [_bottomImageView setContentMode:UIViewContentModeScaleToFill];
    ...
    [self setImagesContentMode:UIViewContentModeScaleToFill];
...
- (void) populateImageView:(UIImageView*) imageView andIndex:(NSUInteger) index
{
        ...
        NSString * imageName = (NSString *) dataObj;
         ...
         if ([imageName containsString:@"http"]){
            // check is string is a url? by checking if it contains http
             ...
             [imageView sd_setImageWithURL:[NSURL URLWithString:imageName] placeholderImage:[UIImage imageNamed:@"logo"] completed:nil];
    ...
    } else if ([dataObj isKindOfClass:[NSURL class]])
    {
        ...
        [imageView sd_setImageWithURL:imageURL placeholderImage:[UIImage imageNamed:@"logo"]];
    } else {
...
+ (instancetype)sharedInstance{
    static KASlideShow *sharedInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [[KASlideShow alloc] init];
